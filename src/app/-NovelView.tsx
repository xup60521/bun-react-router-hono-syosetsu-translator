...
import { NovelContentLoading, SidePanelLoading, NovelViewLoading } from "./-NovelViewLoading";
...
export default function NovelView({
    ...
    const query = useQuery({
        ...
        queryFn: async () => {
            ...
            const data = await (await client.api.tools["novel-handler"].$post({
                json: { url: selectedNovelURL },
            })).json();
            if ("error" in data) {
                throw new Error(data.error);
            }
            // const data = await novel_handler({
            //     data: { url: selectedNovelURL },
            // });
            return data;
        },
    });
...
function SidePanel({
    ...
    const { isLoading, error, data } = useQuery({
        ...
        queryFn: async () => {
            ...
            const res = await client.api.decompose.$post({
                json: { url_string },
            });
            ...
            // const data = await decompose_url({ data: { url_string } });
