...
import z from "zod";
import NovelView from "@/app/-NovelView";
...
export default function App() {
    ...
    const urlString = location.state?.url_string ?? "";
                ...
                >
                    ...
                    <Popover>
                        ...
                        <PopoverContent className="border-2 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] bg-white dark:bg-zinc-900 p-0 w-56 rounded-none">
                            <ThemeMenu />
                            <Link to="/settings" className="flex items-center gap-3 p-3 font-mono font-bold hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors group">
